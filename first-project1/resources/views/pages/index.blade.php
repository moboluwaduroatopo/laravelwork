  ...
  <div id="carousel-example-1z" class="carousel slide carousel-fade pt-4" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="carousel-item">
        <div class="view" style="background-image: url('img/back4.jpg'); background-repeat: no-repeat; background-size: cover;">
      ...
      <!--Third slide-->
      <div class="carousel-item">
        <div class="view" style="background-image: url('img/back1.jpg'); background-repeat: no-repeat; background-size: cover;">
  ...
  <main>
    <div class="container">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark mdb-color lighten-3 mt-3 mb-5">
        ...
        <!-- Navbar brand -->
        <span class="navbar-brand">All Product</span>
