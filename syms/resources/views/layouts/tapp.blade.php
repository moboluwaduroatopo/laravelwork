...
<div class="wrapper">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components">
            ...
            <li>
                <a href="/exam_result">Student Exam Result</a>
            </li>
            <li  ><a href="/showexamresult"> Result List</a></li>
            <li>
                <a href="#pageSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Class</a>
                <ul class="collapse list-unstyled" id="pageSubmenu">
                    <li>
                        <a href="class">Add Class</a>
                    </li>
                    <li>
                        <a href="#">Page 2</a>
                    </li>
            ...
            @else
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="tprofile">{{ __('Profile') }}</a>
