    ...
    <div class="row ">
        <div class="col-md-10 col-md-offset-1">
            ...
            <form enctype="multipart/form-data" action="/profile" method="POST">
              ...
              <!--address-->
              <div class="md-form mb-5">
                <input type="text" id="email" name="email" class="form-control" placeholder=""  value="{{Auth::user()->email}}">
              
              </div>

              <!--address-2-->
              <div class="md-form mb-5">
                <input type="text" id="address-2" name="parent_name" class="form-control" placeholder=""  value="{{Auth::user()->parent_name}}">
              ...
              <!--address-->
              <div class="md-form mb-5">
                <input type="text" id="address" name="parent_phone" class="form-control" placeholder=""  value="{{Auth::user()->parent_phone}}">
