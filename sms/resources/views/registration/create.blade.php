...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Student Register Here') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            {{Form::label('title', 'Parent_name', ['class'=>'col-md-4 col-form-label text-md-right'])}}
                            <div class="col-md-6">
                         ...
                         <div class="form-group row">
                            {{Form::label('title', 'Parent_phone', ['class'=>'col-md-4 col-form-label text-md-right'])}}
                            <div class="col-md-6">
                                {{Form::text('parent_phone','',['class'=>'form-control'])}}
