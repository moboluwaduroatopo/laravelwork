            ...
            <div class="card">
                ...
                <div class="card-body">
                    <!-- <form method="POST" action="{{ route('register') }}"> -->
                        {!! Form::open(['action'=>['ProductController@update',$pro->id],'method' => 'PUT']) !!}
                        
                         <div class="form-group row">
                            {{Form::label('title', 'Product Name', ['class'=>'col-md-4 col-form-label text-md-right'])}}
                            <div class="col-md-6">
                                {{Form::text('product_name',$pro->product_name,['class'=>'form-control'])}}
                         ...
                         <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                {{Form::text('cprice',$pro->cprice,['class'=>'form-control'])}}
                                
                            </div>
                        </div>  <div class="form-group row">
                            {{Form::label('title', 'PPrice', ['class'=>'col-md-4 col-form-label text-md-right'])}}
                            <div class="col-md-6">
                                {{Form::text('pprice',$pro->pprice,['class'=>'form-control'])}}
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                {{Form::text('quantity',$pro->quantity,['class'=>'form-control'])}}
                      ...
                      <!--   <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                  <textarea class="form-control" name="shortd"  id="exampleTextarea" rows="3">{{$pro->shortd}}</textarea>
