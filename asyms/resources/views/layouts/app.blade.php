    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav nav-flex-icons">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('register') }}">{{ __('AdminReg') }}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/teacherreg">{{ __('TeacherReg') }}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/create">{{ __('StudentReg') }}</a>
            </li>
          {{-- <li class="nav-item">
            <a class="nav-link waves-effect" href="/cart-show">
